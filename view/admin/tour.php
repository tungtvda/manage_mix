...
{
    return '<th>id</th><th>tour_quoc_te</th><th>DanhMuc1Id</th><th>DanhMuc2Id</th><th>danhmuc_multi</th><th>promotion</th><th>packages</th><th>name</th><th>name_url</th><th>count_down</th><th>code</th><th>img</th><th>price_sales</th><th>price</th><th>price_2</th><th>price_3</th><th>price_4</th><th>price_5</th><th>price_6</th><th>price_number</th><th>price_number_2</th><th>price_number_3</th><th>price_number_4</th><th>price_number_5</th><th>price_number_6</th><th>name_price</th><th>name_price_2</th><th>name_price_3</th><th>name_price_4</th><th>name_price_5</th><th>name_price_6</th><th>so_cho</th><th>durations</th><th>departure</th><th>destination</th><th>departure_time</th><th>vehicle</th><th>hotel</th><th>summary</th><th>highlights</th><th>schedule</th><th>price_list</th><th>content</th><th>list_img</th><th>title</th><th>keyword</th><th>description</th><th>inclusion</th><th>exclusion</th>';
}
//
function showTableBody($data)
{
    ...
    if(count($data)>0) foreach($data as $obj)
    {
        ...
        $TableBody.="<td>".$obj->count_down."</td>";
        $TableBody.="<td>".$obj->code."</td>";
        $TableBody.="<td>".$obj->img."</td>";
        $TableBody.="<td>".$obj->price_sales."</td>";
        $TableBody.="<td>".$obj->price."</td>";
        $TableBody.="<td>".$obj->price_2."</td>";
        $TableBody.="<td>".$obj->price_3."</td>";
        $TableBody.="<td>".$obj->price_4."</td>";
        $TableBody.="<td>".$obj->price_5."</td>";
        $TableBody.="<td>".$obj->price_6."</td>";
        $TableBody.="<td>".$obj->price_number."</td>";
        $TableBody.="<td>".$obj->price_number_2."</td>";
        $TableBody.="<td>".$obj->price_number_3."</td>";
        $TableBody.="<td>".$obj->price_number_4."</td>";
        $TableBody.="<td>".$obj->price_number_5."</td>";
        $TableBody.="<td>".$obj->price_number_6."</td>";
        $TableBody.="<td>".$obj->name_price."</td>";
        $TableBody.="<td>".$obj->name_price_2."</td>";
        $TableBody.="<td>".$obj->name_price_3."</td>";
        $TableBody.="<td>".$obj->name_price_4."</td>";
        $TableBody.="<td>".$obj->name_price_5."</td>";
        $TableBody.="<td>".$obj->name_price_6."</td>";
        $TableBody.="<td>".$obj->so_cho."</td>";
        $TableBody.="<td>".$obj->durations."</td>";
        $TableBody.="<td>".$obj->departure."</td>";
        $TableBody.="<td>".$obj->destination."</td>";
        $TableBody.="<td>".$obj->departure_time."</td>";
        $TableBody.="<td>".$obj->vehicle."</td>";
        $TableBody.="<td>".$obj->hotel."</td>";
        $TableBody.="<td>".$obj->summary."</td>";
        $TableBody.="<td>".$obj->highlights."</td>";
        $TableBody.="<td>".$obj->schedule."</td>";
        $TableBody.="<td>".$obj->price_list."</td>";
        $TableBody.="<td>".$obj->content."</td>";
        $TableBody.="<td>".$obj->list_img."</td>";
        $TableBody.="<td>".$obj->title."</td>";
        $TableBody.="<td>".$obj->keyword."</td>";
        $TableBody.="<td>".$obj->description."</td>";
        $TableBody.="<td>".$obj->inclusion."</td>";
        $TableBody.="<td>".$obj->exclusion."</td>";
...
{
    $str_from='';
    $str_from.='<p><label>tour_quoc_te</label><input class="text-input small-input" type="text"  name="tour_quoc_te" value="'.(($form!=false)?$form->tour_quoc_te:'').'" /></p>';
    $str_from.='<p><label>DanhMuc1Id</label><input class="text-input small-input" type="text"  name="DanhMuc1Id" value="'.(($form!=false)?$form->DanhMuc1Id:'').'" /></p>';
    $str_from.='<p><label>DanhMuc2Id</label><input class="text-input small-input" type="text"  name="DanhMuc2Id" value="'.(($form!=false)?$form->DanhMuc2Id:'').'" /></p>';
    ...
    $str_from.='<p><label>promotion</label><input class="text-input small-input" type="text"  name="promotion" value="'.(($form!=false)?$form->promotion:'').'" /></p>';
    $str_from.='<p><label>packages</label><input class="text-input small-input" type="text"  name="packages" value="'.(($form!=false)?$form->packages:'').'" /></p>';
    ...
    $str_from.='<p><label>price_number_4</label><input class="text-input small-input" type="text"  name="price_number_4" value="'.(($form!=false)?$form->price_number_4:'').'" /></p>';
    $str_from.='<p><label>price_number_5</label><input class="text-input small-input" type="text"  name="price_number_5" value="'.(($form!=false)?$form->price_number_5:'').'" /></p>';
    $str_from.='<p><label>price_number_6</label><input class="text-input small-input" type="text"  name="price_number_6" value="'.(($form!=false)?$form->price_number_6:'').'" /></p>';
    ...
    $str_from.='<p><label>name_price_4</label><input class="text-input small-input" type="text"  name="name_price_4" value="'.(($form!=false)?$form->name_price_4:'').'" /></p>';
    $str_from.='<p><label>name_price_5</label><input class="text-input small-input" type="text"  name="name_price_5" value="'.(($form!=false)?$form->name_price_5:'').'" /></p>';
    $str_from.='<p><label>name_price_6</label><input class="text-input small-input" type="text"  name="name_price_6" value="'.(($form!=false)?$form->name_price_6:'').'" /></p>';
    $str_from.='<p><label>so_cho</label><input class="text-input small-input" type="text"  name="so_cho" value="'.(($form!=false)?$form->so_cho:'').'" /></p>';
