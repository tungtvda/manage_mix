...
//                $('#con_lai').html('');
                ...
                if (item.data('id')) {
                    link = url + '/bang-gia-dich-vu.html';
                    $.ajax({
                        method: 'GET',
                        url: link,
                            ...
                            try {
                                ...
                                if (response.success == 1) {
                                    if(response.list_dich_vu!=''){
                                        ...
                                        $('#input_loi_nhuan_m3').val(response.data.loi_nhuan_m3);
                                        $('#price_loinhuan_format').html(response.data.loi_nhuan_format);
                                        $('#price_loinhuan_format_1').html(response.data.loi_nhuan_m1_format);
                                        $('#price_loinhuan_format_2').html(response.data.loi_nhuan_m2_format);
                                        $('#price_loinhuan_format_3').html(response.data.loi_nhuan_m3_format);
