    ...
    if($_GET['user_id']==$_SESSION['user_id']){
        ...
        foreach($data_noti as $row_noti_menu){
            ...
            $string_noti.='  <li style="position: relative; '.$bg.'">
                                    ...
                                    <a title="Chi tiết thông báo" href="'.SITE_NAME.'/notification/detail?id='._return_mc_encrypt($row_noti_menu->id, ENCRYPTION_KEY).'" style="border: none;;position: absolute;right: 0%;bottom: 5%; ">
                                    '.$icon.'
                                    </a>
                                </li>';
        }
