...
class booking
{
    public $id,$code_booking,$id_tour,$name_tour,$code_tour,$price_tour, $price_tiep_thi,$price_tiep_thi_thuc_te,$level_tiep_thi,$level_gioi_thieu_tiep_thi,$status_tiep_thi,$confirm_admin_tiep_thi,$price_11,$price_5,$price_new,$price_11_new,$price_5_new,$vat,$nguon_tour,$tien_te,$ty_gia,$ngay_bat_dau,$han_thanh_toan,$loai_khach_hang,$hinh_thuc_thanh_toan,$id_customer,$diem_don,$diem_tra,$ngay_khoi_hanh,$ngay_ket_thuc,$phuong_tien,$num_nguoi_lon,$num_tre_em,$num_tre_em_5,$price_number,$price_number_2,$price_number_3,$name_price,$name_price_2,$name_price_3,$total_price,$tien_thanh_toan,$user_id,$user_tiep_thi_id,$status,$confirm_admin,$created_by,$updated_by,$created,$updated,$note;
    ...
    $this->level_gioi_thieu_tiep_thi=isset($data['level_gioi_thieu_tiep_thi'])?$data['level_gioi_thieu_tiep_thi']:'';
    ...
    public function encode()
        {
            ...
            $this->level_gioi_thieu_tiep_thi=addslashes($this->level_gioi_thieu_tiep_thi);
    ...
    public function decode()
        {
            ...
            $this->level_gioi_thieu_tiep_thi=stripslashes($this->level_gioi_thieu_tiep_thi);
