...
<link rel="stylesheet" href="<?php echo SITE_NAME?>/view/default/themes/admin/js/autoComplete/jquery.auto-complete.css">
    ...
    $(function(){
        ...
        $('#name_customner').autoComplete({
            ...
            onSelect: function(e, term, item){
                ...
                $('#name_customner').val(item.data('langname')+' ('+item.data('lang')+')');
            }
        });
    });
