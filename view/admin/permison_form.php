...
function view_permison_form($data)
{
    ...
    $ft->assign('TABLE-NAME','permison_form');
...
{
    return '<th>id</th><th>module_id</th><th>name</th><th>url</th><th>action_count</th><th>dk_count</th><th>active</th><th>status</th><th>position</th>';
}
//
