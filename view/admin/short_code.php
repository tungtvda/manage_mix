...
function view_short_code($data)
{
    ...
    $ft->assign('TABLE-NAME','short_code');
...
{
    return '<th>id</th><th>type</th><th>name</th><th>field</th><th>description</th><th>position</th>';
}
//
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>field</label><input class="text-input small-input" type="text"  name="field" value="'.(($form!=false)?$form->field:'').'" /></p>';
