<?php
function returnEmailHotel01218(){
    return '<head>
    <title>{{TITLE}}</title>
                            ...
                            <tr>
                                <td class="paddingB30pxLR20px"
                                    ...
                                    <div class="link_khoi_hanh" style="float: left; width: 100%; margin-bottom: 40px; text-align: center;    margin-top: 20px;">
                                       <a href="{{LINK_DETAIL}}" style=" text-decoration: none;color: #ffffff;background-color: #f36f21;padding: 10px 10px;font-size: 16px;">Mời bạn theo dõi: chi tiết đơn hàng tại đây >></a>
                                    </div>
