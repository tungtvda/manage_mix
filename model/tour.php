...
class tour
{
    public $id,$tour_quoc_te,$DanhMuc1Id,$DanhMuc2Id,$danhmuc_multi,$promotion,$packages,$name,$name_url,$count_down,$code,$img,$price_sales,$price,$price_2,$price_3,$price_4,$price_5,$price_6,$durations,$departure,$destination,$departure_time,$vehicle,$hotel,$summary,$highlights,$schedule,$price_list,$content,$list_img,$title,$keyword,$description,$inclusion,$exclusion;
